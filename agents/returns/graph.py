...
from response_schemas.return_model import ReturnsAnalysis
...
"""
    ...
    structured_llm = model.with_structured_output(ReturnsAnalysis)
    analysis: ReturnsAnalysis = await structured_llm.ainvoke([
...
def write_state_outputs(state: ReturnsAgentState) -> dict:
    ...
    """
    analysis = ReturnsAnalysis.model_validate_json(state["raw_analysis"])
